...
const GlobalPresencePage = () => {
  const {
    ...
    control,
    formState: { errors },
  } = useForm<GlobalPresenceFormProps>();
  ...
  return (
    <div className="flex flex-col gap-5">
      <form
        ...
        onSubmit={handleSubmit(handleAddGlobalPresence)}
      >
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex flex-col gap-2">
                        ...
                        <Input
                          ...
                          placeholder="Title"
                          {...register(
                            `thirdSection.countries.${index}.title`,
                            {
                              required: "Title is required",
                            },
                          )}
                        />
                        {errors.thirdSection?.countries?.[index]?.title && (
                          <p className="text-red-500">
                            {
                              errors.thirdSection?.countries?.[index]?.title
                                .message
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Input
                          type="text"
                          placeholder="Slug"
                          {...register(`thirdSection.countries.${index}.slug`, {
                        ...
                        />
                        {errors.thirdSection?.countries?.[index]?.slug && (
                          <p className="text-red-500">
                            {
                              errors.thirdSection?.countries?.[index]?.slug
                                .message
                    ...
                    <div className="flex flex-col gap-2">
                      <div>
                        ...
                        />
                        {errors.thirdSection?.countries?.[index]?.image && (
                          <p className="text-red-500">
                            {
                              errors.thirdSection?.countries?.[index]?.image
                                .message
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          {...register(
                            `thirdSection.countries.${index}.imageAlt`,
                            {
                              required: "Image Alt is required",
                            },
                          )}
                        />
                        {errors.thirdSection?.countries?.[index]?.imageAlt && (
                          <p className="text-red-500">
                            {
                              errors.thirdSection?.countries?.[index]?.imageAlt
                                .message
        ...
        <SeoFields<GlobalPresenceFormProps> control={control} register={register} errors={errors} />

        <div className="flex justify-center">
          <Button
            type="submit"
            className="cursor-pointer text-white w-full text-[16px]"
          >
            Submit
          </Button>
        </div>
