...
const HsePage = () => {
  ...
  const handleAddItem = (index: number) => {
    ...
    setValue(`fourthSection.years.${index}.items`, [
      ...currentItems,
      { number: "", value: "" },
    ]);
  };
  ...
  const handleRemoveItem = (index: number, itemIndex: number) => {
    const currentItems = watch(`fourthSection.years.${index}.items`) || [];
    setValue(
      `fourthSection.years.${index}.items`,
  ...
  return (
    <div className="flex flex-col gap-5">
      <form
        ...
        onSubmit={handleSubmit(handleAddHse)}
      >
          ...
          <div className="p-5 rounded-md flex flex-col gap-2">
            <div className="flex flex-col gap-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="flex flex-col gap-2">
                  <div className="flex flex-col gap-2">
                    ...
                    {errors.firstSection?.secondImage && (
                      <p className="text-red-500">
                        {errors.firstSection?.secondImage.message}
                      </p>
                    )}
                  </div>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex flex-col gap-2">
                    <Label className="font-bold">Second-Image Alt Tag</Label>
                    <Input
                      type="text"
                      placeholder="Alt Tag"
                      {...register(`firstSection.secondImageAlt`, {
                        required: "Value is required",
                      })}
                    />
                    {errors.firstSection?.secondImageAlt && (
                      <p className="text-red-500">
                        {errors.firstSection?.secondImageAlt.message}
                      </p>
                    )}
                  </div>
                </div>
                          ...
                          >
                            ...
                            <div className="flex flex-col gap-2">
                              <div className="flex flex-col gap-2">
                                ...
                                />
                                {errors.secondSection?.items?.[index]?.files?.[
                                  fileIndex
                                ]?.file && (
                                  <p className="text-red-500">
                                    {
                                      errors.secondSection?.items?.[index]
                                        ?.files?.[fileIndex]?.file.message
                                    }
                                  </p>
                                )}
                              </div>
                              ...
                              <div className="flex flex-col gap-2">
                                <div className="flex flex-col gap-2">
                                  ...
                                  <Input
                                    ...
                                    placeholder="Title"
                                    {...register(
                                      `secondSection.items.${index}.files.${fileIndex}.title`,
                                      {
                                        required: "Title is required",
                                      }
                                    )}
            ...
            <div className="p-5 rounded-md flex flex-col gap-5">
              ...
              <div className="border p-2 rounded-md">
                {fourthSectionItems.map((field, index) => (
                  <div
                    key={field.id}
                    className="grid grid-cols-1 gap-2 relative border-b p-2 pb-5 last:border-b-0"
                  >
                    <div className="absolute top-2 right-2">
                      <RiDeleteBinLine
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex flex-col gap-2">
                        ...
                        <Input
                          type="text"
                          placeholder="Year"
                          {...register(`fourthSection.years.${index}.title`)}
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {watch(`fourthSection.years.${index}.items`).map(
                        (item, itemIndex) => (
                          <div
                            key={itemIndex}
                            className="grid grid-cols-1 gap-2 relative border p-2 rounded-md"
                            ...
                            <div className="flex flex-col gap-2">
                              <div className="flex flex-col gap-2">
                                ...
                                <Input
                                  ...
                                  placeholder="Number"
                                  {...register(
                                    `fourthSection.years.${index}.items.${itemIndex}.number`
                                  )}
                                />
                              </div>
                              ...
                              <div className="flex flex-col gap-2">
                                <div className="flex flex-col gap-2">
                                  ...
                                  <Input
                                    ...
                                    placeholder="Value"
                                    {...register(
                                      `fourthSection.years.${index}.items.${itemIndex}.value`,
                                      {
                                        required: "Value is required",
                                      }
                                    )}
                                  />
                                  {errors.fourthSection?.years?.[index]
                                    ?.items?.[itemIndex]?.value && (
                                    <p className="text-red-500">
                                      {
                                        errors.fourthSection?.years?.[index]
                                          ?.items?.[itemIndex]?.value.message
                                      }
                                    </p>
                                  )}
                                </div>
              ...
              <div className="flex justify-end mt-2">
                <Button
                  type="button"
                  addItem
                  onClick={() => fourthSectionAppend({ title: "", items: [] })}
                >
                  Add Year
                </Button>
              </div>
