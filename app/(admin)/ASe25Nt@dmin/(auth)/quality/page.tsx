...
const QualityPage = () => {
  ...
  const {
    fields: certificateSectionItems,
    append: certificateSectionAppend,
    remove: certificateSectionRemove,
  } = useFieldArray({
    control,
    ...
    try {
      ...
      if (response.ok) {
        ...
        setValue(
          ...
          data.data.certificateSection.items
        );
  ...
  return (
    <div className="flex flex-col gap-5">
      <form
        ...
        onSubmit={handleSubmit(handleAddQuality)}
      >
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-1">
                ...
                <Input
                  type="text"
                  placeholder="Title"
                  {...register("certificateSection.title", {
                    required: "Title is required",
                  })}
                />
                {errors.certificateSection?.title && (
                  <p className="text-red-500">
                    {errors.certificateSection?.title.message}
                  </p>
                )}
              </div>
            </div>
                ...
                {certificateSectionItems.map((field, index) => (
                  ...
                  >
                    <div className="absolute top-2 right-2">
                      <RiDeleteBinLine
                        onClick={() => certificateSectionRemove(index)}
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                          ...
                          <Input
                            ...
                            placeholder="Alt Tag"
                            {...register(
                              `certificateSection.items.${index}.imageAlt`,
                              {
                                required: "Value is required",
                              }
                            )}
                          />
                          {errors.certificateSection?.items?.[index]
                            ?.imageAlt && (
                            <p className="text-red-500">
                              {
                                errors.certificateSection?.items?.[index]
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Input
                  ...
                  {...register("thirdSection.secondTitle", {
                    required: "Second Title is required",
                  })}
                />
                {errors.thirdSection?.secondTitle && (
                  <p className="text-red-500">
                    {errors.thirdSection?.secondTitle.message}
                  </p>
                )}
              </div>
              <div className="flex flex-col gap-1">
                ...
                {errors.thirdSection?.secondDescription && (
                  <p className="text-red-500">
                    {errors.thirdSection?.secondDescription.message}
                  </p>
                )}
              </div>
            </div>
        ...
        <div className="flex flex-col gap-2">
          <Label className="pl-3 font-bold">Og Title</Label>
          <Input
            type="text"
        ...
        <div className="flex flex-col gap-2">
          <Label className="pl-3 font-bold">Og Description</Label>
          <Input
            type="text"
        ...
        <div className="flex flex-col gap-2">
          <Label className="pl-3 font-bold">Twitter Title</Label>
          <Input
            type="text"
            placeholder="Falls back to Meta Title if empty"
        ...
        <div className="flex flex-col gap-2">
          <Label className="pl-3 font-bold">Twitter Description</Label>
          <Input
            type="text"
            placeholder="Falls back to Meta Description if empty"
        ...
        <div className="flex flex-col gap-2">
          <Label className="pl-3 font-bold">Schema</Label>
