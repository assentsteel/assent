                            ...
                            <div>
                                <div className='flex flex-col gap-5 border p-2 rounded-md'>
                                    ...
                                    {fourthSectionItems.map((field, index) => (
                                        ...
                                        <div key={field.id} className='border-b pb-5 last:border-b-0'>

                                            <div className='flex flex-col gap-2 w-1/2 p-5'>
                                                <Controller
                                                    name={`fourthSection.items.${index}.style`}
                                                    control={control}
                                            ...
                                            <div key={field.id} className='grid grid-cols-2 gap-2 relative border-b p-2 h-fit last:border-b-0'>
                                                <div className='absolute top-2 right-2'>
                                                    <RiDeleteBinLine onClick={() => fourthSectionRemove(index)} className='cursor-pointer text-red-600' />
                                                </div>

                                                {watch(`fourthSection.items.${index}.style`) === "3d-file" && (
                                                    <>
                                                        <div className='flex flex-col gap-2'>
                                                            <div className='flex flex-col gap-2'>
                                                                <Label className='pl-3 font-bold'>3d File</Label>
                                                                <Controller
                                                                    name={`fourthSection.items.${index}.threeDFile`}
                                                                    control={control}
                                                                ...
                                                                />
                                                                {errors.fourthSection?.items?.[index]?.threeDFile && (
                                                                    <p className="text-red-500">{errors.fourthSection?.items?.[index]?.threeDFile.message}</p>
                                                                )}
                                                                <Label className='pl-3 font-bold'>Alt Tag</Label>
                                                                <Input type='text' placeholder='Alt Tag' {...register(`fourthSection.items.${index}.threeDFileAlt`, {
                                                                    required: "Value is required"
                                                                })} />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            <div className='flex flex-col gap-2'>
                                                                ...
                                                                <Controller
                                                                    name={`fourthSection.items.${index}.threeDFileThumbnail`}
                                                                    control={control}
                                                                    rules={{ required: "Image is required" }}
                                                                    render={({ field }) => (
                                                                        <ImageUploader
                                                                ...
                                                                />
                                                                {errors.fourthSection?.items?.[index]?.threeDFileThumbnail && (
                                                                    <p className="text-red-500">{errors.fourthSection?.items?.[index]?.threeDFileThumbnail.message}</p>
                                                                )}
                                                            </div>

                                                            <div className='flex flex-col gap-2'>
                                                                <Label className='font-bold'>Alt Tag</Label>
                                                                <Input type='text' placeholder='Alt Tag' {...register(`fourthSection.items.${index}.threeDFileAltThumbnail`, {
                                                                    required: "Value is required"
                                                                })} />
                                                            </div>
                                                ...
                                                {watch(`fourthSection.items.${index}.style`) === "image" && (
                                                    <>
                                                        <div className='flex flex-col gap-1'>
                                                            <Label className='font-bold'>Image</Label>
                                                            <Controller
                                                ...
                                                {watch(`fourthSection.items.${index}.style`) === "" && (
                                                    <div className='flex flex-col gap-2 pl-4 text-green-500'>
                                                        Select a style from the dropdown above
                                                    </div>
                                                )}
                                ...
                                <div className='flex justify-end mt-2'>
                                    <Button type='button' addItem onClick={() => fourthSectionAppend({ image: "", imageAlt: "", threeDFile: "", threeDFileAlt: "", style: "", threeDFileThumbnail: "", threeDFileAltThumbnail: "" })}>Add Item</Button>
                                </div>
                            </div>
                        </div>
