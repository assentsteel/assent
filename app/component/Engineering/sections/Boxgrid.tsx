              ...
              <div key={expertise.id}>
                  ...
                  <div key={expertise.id}>
                    <Link href={`${expertise.url}`}>
                      <div
                        key={expertise.id}
                        className="group flex flex-col justify-between gap-3 border p-5 transition-all duration-500 hover:bg-secondary  hover:bg-[url('/assets/img/about/hrbn1.jpg')] md:h-[300px]  lg:h-[340px] lg:gap-0 lg:p-10 xl:h-[414px]"
                      >
                        {/* Image Wrapper */}
