  ...
  const navItems = [
    ...
    // { name: "Clients", href: "/ASe25Nt@dmin/clients", icon: PresentationChartBarIcon },
    {
      ...
      children: [
        ...
        {
          name: "Steel Erection",
          href: "/ASe25Nt@dmin/services/steel-erection",
        },
      ],
    },
    ...
    //       name: country.title,
    //       href: `/ASe25Nt@dmin/global-presence/${country._id}`,
    //     })),
    //   ],
    // },
    {
      ...
      children: [
        { name: "Main Page", href: "/ASe25Nt@dmin/global-presence" },
        { name: "North America (USA)", href: "/ASe25Nt@dmin/global-presence/north-america" },
        { name: "Europe", href: "/ASe25Nt@dmin/global-presence/europe" },
        { name: "Africa", href: "/ASe25Nt@dmin/global-presence/africa" },
        { name: "United Kingdom", href: "/ASe25Nt@dmin/global-presence/united-kingdom" },
        { name: "Australia", href: "/ASe25Nt@dmin/global-presence/australia" },
      ],
    },
