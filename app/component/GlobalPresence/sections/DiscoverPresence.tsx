  ...
  return (
    <section className="py-[50px] md:py-[70px] xl:py-[100px]    relative  ">
      <div className="container">
        <motion.h3   variants={slideInTop}
  initial="hidden"
                 whileInView="visible"
                 exit="exit"
          className="text-xl font-semibold text-primary  leading-[1.2] mb-5 md:mb-10">Discover Our <br />
Presence in Other Countries</motion.h3>
<motion.div
      ...
      >
        ...
        <figure className="overlayclr ">
          <Image
            src={item.image}
            alt=""
            className="rounded-[15px] w-full object-cover h-[350px] md:h-auto"
            priority
          />
        </figure>
