    ...
    <section className="section-spacing overflow-hidden">
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-[10px] mb-[40px]">
          <div className="md:flex md:flex-row flex-wrap md:w-[70%] flex flex-col gap-2">
          ...
          <div className="mt-5 md:mt-0">
            <motion.div
              className="flex items-center justify-end gap-2 lg:gap-[60px]"
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="relative">
          ...
          >
            ...
            >
              {activeCategory !== null &&
                data.categories[activeCategory]?.projects
                  .slice(0, 10)
                  .map((project, index) => (
                    <SwiperSlide key={index} className="">
                      ...
                      >
                        ...
                        >
                          ...
                          <p className="text-sm text-[#595959] leading-none font-normal py-[25px] border-b border-[#1F1F1F]">
                            {project.sector}
                          </p>
                          <h3 className="text-lg font-semibold leading-none pt-[25px]">
                            {project.title}
                          </h3>
                        </motion.div>
                      </Link>
