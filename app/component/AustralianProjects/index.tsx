...
//   return (
//     <>
//       {sectionData && <IntrosectionBold data={singletextimg} />} 

//       <FirstSection data={sectionData} />

//       <GlobalReachprojects bgcolor="bg-primary" data={reach} />
//       <HeadingText data={sectwo} />
//       <HowweWork data={howwework} />
//       <KeyCapabilities data={keycap} navigation={true} />
//       <GridBox colnum={4} data={gridsbox} />
//       <WhyAssent data={whyus} />

//       <SaftySustainablity colnum={3} data={susbata} maxchwidth={30} />
...
import AccordionAus from "./sections/AccordionAus";
import SingleImageText from "./sections/SingleImageText";
import type { GlobalPresencePageData } from "./types";

const AustralianProjects = ({ data }: { data: GlobalPresencePageData }) => {
  return (
    <>
      <IntrosectionBold data={data.firstSection} />
      <FirstSection data={data.firstSection} />
      <GlobalReachprojects bgcolor="bg-primary" data={data.secondSection} />
      <HeadingText data={data.thirdSection} />
      <HowweWork data={data.fourthSection} />
      <KeyCapabilities data={data.fifthSection} navigation={true} />
      <GridBox colnum={4} data={data.sixthSection} />
      <WhyAssent data={data.seventhSection} />
      <SaftySustainablity colnum={3} data={data.eighthSection} maxchwidth={30} />
      <PartnershipModel data={data.ninthSection} />
      <AccordionAus data={data.tenthSection} />
      <SingleImageText data={data.eleventhSection} textright={false} />
      <Faq data={data.twelfthSection} />
    </>
  );
};

export default AustralianProjects;
