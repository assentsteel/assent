...
import { GPEighthSection } from "../types";
...
const SaftySustainablity = ({
  data,
  maxchwidth,
  colnum,
}: {
  data: GPEighthSection;
  colnum?: number;
  maxchwidth?: number;
}) => {
  return (
        ...
        <div className="flex flex-col   ">
          <div className="mb-5 lg:mb-[60px]">
            <motion.h2
              ...
              exit="exit"
              className="text-xl text-primary font-[600] leading-[1.2] xxl:leading-[1.36] mb-4 lg:mb-[30px]"
            ...
            >
              <motion.p
                className="text-19   font-400   text-tertiary   lg:max-w-[92ch]"
                custom="y"
          ...
          <motion.div
            className="mt-5 lg:mt-[30px] text-sm max-w-[55ch] max-w-[97ch]"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }} // Trigger animation once when 50% visible
            variants={{
