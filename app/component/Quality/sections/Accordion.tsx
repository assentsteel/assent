    ...
    <section className="pt-[50px] md:pt-[70px] xl:pt-[100px] pb-[50px] md:pb-[70px] xl:pb-[100px] cpt0  overflow-hidden relative ">
      <div className="container">
        <div className="lg:flex lg:items-center xxl:items-start">
          <div className="w-full lg:w-[30%] pr-0 lg:pr-[35px]">
            <motion.h2
          ...
          <div className="w-full lg:w-[70%] pl-0 lg:pl-[25px] mt-6 lg:mt-0">
            {data.fifthSection.items.map((da, index) => (
              <motion.div
                key={index}
                className="group border-b first:border-t border-[#00000015] py-5 lg:py-[20px] xxl:py-[34px] transition-all duration-300"
