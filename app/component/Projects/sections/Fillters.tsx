...
const dropdowns = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "c", label: "Data Centre Projects" },
    ],
  },
  {
    label: "Sector",
    options: [
      { value: "", label: "Sector" },
      { value: "", label: "Airport" },
      { value: "", label: "Arena/Stadiums" },
      { value: "", label: "Education" },
      { value: "", label: "High Rise Tower" },
      { value: "", label: "Leisure Centre" },
      { value: "", label: "Metro Rail - Depots & Stabling Yard" },
      { value: "", label: "Metro Rail - Stations" },
      { value: "", label: "Museum/Cultural Centres" },
      { value: "", label: "Retail/Residential Building" },
      { value: "", label: "Shopping Mall" },
    ],
  },
];
const Fillters = ({ }) => {
