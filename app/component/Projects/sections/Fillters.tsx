...
const dropdowns = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "arena", label: "Arena/Stadiums" },
      { value: "education", label: "Education" },
      { value: "tower", label: "High Rise Tower" },
      { value: "leisure", label: "Leisure Centre" },
      { value: "metro_depot", label: "Metro Rail - Depots & Stabling Yard" },
      { value: "metro_station", label: "Metro Rail - Stations" },
      { value: "museum", label: "Museum/Cultural Centres" },
      { value: "retail", label: "Retail/Residential Building" },
...
const Fillters = () => {
  ...
  const handleChange = (index: number, option: { value: string; label: string }) => {
    ...
    <section className="relative">
      ...
      >
        <div className="lg:flex gap-20 mb-5 lg:mb-10 pb-5 lg:pb-10 border-b border-[#00000015]">
          ...
          <button className="border whitespace-nowrap font-[500] border-secondary text-xs text-territory uppercase rounded-full py-[8px] px-[20px]">
            Clear filter
          </button>
        </div>
      </motion.div>
