    ...
    <section className="py-[50px] md:py-[70px] xl:py-[100px]   overflow-hidden relative ">
      <div className="container">
        <div className="mb-5 lg:mb-[70px]">
          <h2 className="text-xl  text-primary font-[600] leading-[1.2] ">Core Values</h2>
        </div>
        <div className="flex  border-t border-b border-[#00000025] tabmns justify-between flex-wrap mb-20">
          {[
            "Safety",
            "Quality",
            "We Deliver",
        ...
        <div>
          <div className="lg:flex items-center">
                    <div className="w-full lg:w-1/3 pr-0 lg:pr-[44px]">
                      {data.map((item) => (
                    ...
                    <div className="w-full lg:w-2/3 pl-0 lg:pl-[44px]">
