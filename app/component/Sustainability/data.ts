...
export const about = {
      id: 1,
      title:"",
      heading: "Sustainable Steel Solutions for Future",
      paragraphs: [
        "ASSENT STEEL is dedicated to Corporate Social Responsibility and Sustainable Development, integrating environmental and social considerations into all decisions. We strive for inclusive growth, engaging local communities and adhering to best industry practices. Committed to the UN’s Sustainability Vision 2030, we reduce our environmental impact through efficient resource management and eco-friendly products, ensuring continuous improvement in safety and sustainability."
      ]
};
