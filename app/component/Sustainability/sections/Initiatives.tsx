                  ...
                  <div className="flex gap-5 items-start">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center">
                        {/* TITLE */}
                        <h3 className="text-[17px] md:text-md group-hover:text-secondary transition-all duration-300 leading-[1] font-[500] text-territory pr-6">
                          {da.title}
                        </h3>
                      ...
                      <AnimatePresence mode="wait">
                        {activeIndex === index && (
                          <motion.div
                            ...
                            className="text-territory text-sm font-[400] leading-[1.7] pr-6 overflow-hidden"
                          >
                            <p>{da.description}</p>
                          </motion.div>
                        )}
