...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="container">
        <motion.div className="grid grid-cols-1 md:grid-cols-[56%_auto] xxl:grid-cols-[70%_auto] xxxl:grid-cols-[962px_auto] gap-[30px] xxl:gap-[50px] xxxl:gap-[137px]  mb-[30px] xxxl:mb-[70px]">
          ...
          >
            <motion.h3
              variants={fadeInLeft}
              className="text-lg font-semibold mb-5 lg:mb-[50px]"
            >
              Quick Links
            </motion.h3>
      ...
      <motion.div
        variants={fadeIn}
        className="text-center text-sm mt-5 md:mt-10 lg:mt-[70px] bg-[#0F2C56] py-[20px]"
      >
        <div className="container text-left">
          <p className="text-xs text-white/50">
            &copy; {new Date().getFullYear()} ASSENT STEEL. All rights reserved. | by <Link href={'https://www.globalsurf.ae'} target="_blank">GS Digital</Link>
          </p>
        </div>
      </motion.div>
    </motion.footer>
