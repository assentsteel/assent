...
const WhyChoose: React.FC<ExpertiseSectionProps> = ({ data }) => {

  return (
    <section className="overflow-hidden   py-[50px] md:py-[70px] xl:py-[100px] ">
      <div className="container">
        <div className="  pb-[50px] md:pb-[70px] xl:pb-[100px]">
            <h2 className="mb-5 lg:mb-8 text-xl font-extrabold text-territory">{data.titlesection}</h2>
          <p className=" text-territory">{data.descsection
          }</p>
        </div>
