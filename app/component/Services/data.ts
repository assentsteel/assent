...
export const singletextimg = {
  data: [
    {
      id: 1,
      title: "Precision Erection for Structural Excellence",
      paragraphs: [
        "Our steel erection services ensure precision, stability, and efficiency in every project. With a highly skilled team and advanced techniques, we handle complex installations with speed and accuracy. From planning and material handling to assembly and installation, we optimize every step to enhance safety, reduce costs, and meet project deadlines."
      ],
      image: assets.ser
    }
  ],
