                            ...
                            return (
                                <Link href={`/news/${item.slug}`} key={index}>
                                    ...
                                    >
                                        ...
                                        <motion.div className="absolute bottom-0 z-10 px-5 xxl:px-10 pb-5 xxl:pb-10 w-full">
                                            ...
                                            <motion.h3
                                                variants={textChild}
                                                className="line-clamp-2 text-white text-md xxl:text-lg leading-[1.1] xl:leading-[1.5] mb-2 lg:mb-5 font-[600]"
                                            >
                                                {item.mainTitle}
                                            </motion.h3>
                    ...
                    >
                        {latestNews.slice(1, 3).map((item, index) => {
                            return (
                                ...
                                >
                                    <motion.div variants={textParent} initial="initial" whileHover="hover">
