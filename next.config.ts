...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // -------- News Details new 301--------

      {
        source: "/news-details/eot-crane-post",
        destination: "/news/eot-crane-post",
        permanent: true,
      },
      {
        source: "/news-details/mega-lucky-draw",
        destination: "/news/mega-lucky-draw",
        permanent: true,
      },
      {
        source: "/news-details/project-award-usa-bechtel-and-kiewit",
        destination: "/news/project-award-usa-bechtel-and-kiewit",
        permanent: true,
      },
      {
        source: "/news-details/steel-facts",
        destination: "/news/steel-facts",
        permanent: true,
      },
      {
        source: "/news-details/quiz-time",
        destination: "/news/quiz-time",
        permanent: true,
      },
      {
        source: "/news-details/icv-post",
        destination: "/news/icv-post",
        permanent: true,
      },
      {
        source: "/news-details/team-building-workshop",
        destination: "/news/team-building-workshop",
        permanent: true,
      },
      {
        source: "/news-details/precisionwelding",
        destination: "/news/precisionwelding",
        permanent: true,
      },
      {
        source: "/news-details/voice-of-assent-steel",
        destination: "/news/voice-of-assent-steel",
        permanent: true,
      },
      {
        source: "/news-details/triall-assembly",
        destination: "/news/triall-assembly",
        permanent: true,
      },
      {
        source: "/news-details/excel-and-ppt-training",
        destination: "/news/excel-and-ppt-training",
        permanent: true,
      },
      {
        source: "/news-details/new-year",
        destination: "/news/new-year",
        permanent: true,
      },
      {
        source: "/news-details/lock-out-tag-out-loto",
        destination: "/news/lock-out-tag-out-loto",
        permanent: true,
      },
      {
        source: "/news-details/safety-induction-video-tandem-lifting",
        destination: "/news/safety-induction-video-tandem-lifting",
        permanent: true,
      },
      {
        source: "/news-details/painting",
        destination: "/news/painting",
        permanent: true,
      },
      {
        source: "/news-details/westfield-project-post",
        destination: "/news/westfield-project-post",
        permanent: true,
      },
      {
        source: "/news-details/wellness-month-video",
        destination: "/news/wellness-month-video",
        permanent: true,
      },
      {
        source: "/news-details/voice-of-assent-steel-jan-2025",
        destination: "/news/voice-of-assent-steel-jan-2025",
        permanent: true,
      },
      {
        source: "/news-details/eid-al-adha-greeting",
        destination: "/news/eid-al-adha-greeting",
        permanent: true,
      },
      {
        source: "/news-details/tower-crane-x-4",
        destination: "/news/tower-crane-x-4",
        permanent: true,
      },
      {
        source: "/news-details/fabrication-welder",
        destination: "/news/fabrication-welder",
        permanent: true,
      },
      {
        source: "/news-details/eye-check-up-video-post",
        destination: "/news/eye-check-up-video-post",
        permanent: true,
      },
      {
        source: "/news-details/from-the-sparks-of-fabrication",
        destination: "/news/from-the-sparks-of-fabrication",
        permanent: true,
      },
      {
        source: "/news-details/hse-induction-video",
        destination: "/news/hse-induction-video",
        permanent: true,
      },
      {
